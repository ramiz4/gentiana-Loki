...
const translations = {
  en: {
    ...
    "hero.description":
      "Motivated professional with experience in customer service, administration and finance. Strong organizational skills, communication skills and intercultural competence.",
    ...
    "about.profile.text1":
      "Motivated professional with experience in customer service, administration and finance. Strong organizational skills, communication skills and intercultural competence.",
    "about.profile.text2":
      "Goal is to promote customer satisfaction in the position as Junior Customer Advisor, maintain customer relationships and actively contribute to the success of the company.",
    ...
    "experience.job1.description":
      "Organized appointments and correspondence for the Director. Planned and conducted meetings, events and external meetings. Interface to partner organizations (e.g. UN Women, USAID, GIZ). From May 2013: Expenditure Officer - budget monitoring, expense verification, documentation.",
    ...
    "experience.job2.description":
      "Support with communication measures and press relations. Preparation of reports, briefings and documents. Participation in meetings with local and international stakeholders.",
    ...
    "experience.job3.description":
      "Customer advice and active sales. Design and replenishment of the sales area. Product presentation and customer service.",
    ...
    "experience.job4.description":
      "Reception of visitors, telephone reception. General secretarial tasks, filing and correspondence.",
    ...
    "education.item1.description":
      "Banking, Finance and Accounting - Fama University, Prishtina, Kosovo (October 2011 - December 2021)",
    "education.item1.note":
      "Studies were paused due to marriage and relocation from Kosovo to Germany, resuming after settling in the new country.",
    ...
    "education.item2.description":
      "Banking, Finance and Accounting - Fama University, Prishtina, Kosovo (October 2006 - April 2010)",
    ...
    "education.item3.description":
      "Certificates A1 through B2. Fluent in German, demonstrating strong communication abilities.",
    ...
    "education.item4.description":
      "Pre-Intermediate English - New Age School, Prishtina. Fluent in English for professional communication.",
    ...
    "education.item5.description":
      "Financial sector training from the Ministry of Finance, Prishtina. Specialized in budget monitoring and expense management.",
    ...
    "education.item6.description":
      "Secondary education completed at Jeta e Re, Suhareka, Kosovo (September 2003 - August 2006)",
    ...
    "contact.description":
      "I'm open to discussing new opportunities, collaborations, and how I can contribute my skills to your organization.",
  ...
  de: {
    ...
    "hero.description":
      "Motivierte Fachkraft mit Erfahrung im Kundenservice, in der Verwaltung und im Finanzwesen. Starke organisatorische Fähigkeiten, Kommunikationsfähigkeiten und interkulturelle Kompetenz.",
    ...
    "about.profile.text1":
      "Motivierte Fachkraft mit Erfahrung im Kundenservice, in der Verwaltung und im Finanzwesen. Starke organisatorische Fähigkeiten, Kommunikationsfähigkeiten und interkulturelle Kompetenz.",
    "about.profile.text2":
      "Ziel ist es, die Kundenzufriedenheit in der Position als Junior Customer Advisor zu fördern, Kundenbeziehungen zu pflegen und aktiv zum Erfolg des Unternehmens beizutragen.",
    ...
    "experience.job1.company": "Kosovo Justice Academy, Prishtina, Kosovo",
    "experience.job1.description":
      "Organisation von Terminen und Korrespondenz für den Direktor. Planung und Durchführung von Meetings, Veranstaltungen und externen Treffen. Schnittstelle zu Partnerorganisationen (z.B. UN Women, USAID, GIZ). Ab Mai 2013: Ausgabenbeauftragte - Budgetüberwachung, Ausgabenprüfung, Dokumentation.",
    ...
    "experience.job2.company": "Kosovo Justice Academy, Prishtina, Kosovo",
    "experience.job2.description":
      "Unterstützung bei Kommunikationsmaßnahmen und Pressearbeit. Erstellung von Berichten, Briefings und Dokumenten. Teilnahme an Meetings mit lokalen und internationalen Stakeholdern.",
    ...
    "experience.job3.company": "Mango/Ardi Co, Prishtina, Kosovo",
    "experience.job3.description":
      "Kundenberatung und aktiver Verkauf. Gestaltung und Nachfüllung des Verkaufsbereichs. Produktpräsentation und Kundenservice.",
    ...
    "experience.job4.company": "Lila/Lila Commerce, Suhareka, Kosovo",
    "experience.job4.description":
      "Empfang von Besuchern, Telefonzentrale. Allgemeine Sekretariatsaufgaben, Ablage und Korrespondenz.",
    ...
    "education.item1.title": "Master of Arts",
    "education.item1.description":
      "Banking, Finanz- und Rechnungswesen - Fama Universität, Prishtina, Kosovo (Oktober 2011 - Dezember 2021)",
    "education.item1.note":
      "Das Studium wurde aufgrund von Heirat und Umzug von Kosovo nach Deutschland unterbrochen und nach der Eingewöhnung im neuen Land wieder aufgenommen.",
    "education.item1.tag1": "Banking",
    "education.item1.tag2": "Finanzen",
    "education.item1.tag3": "Rechnungswesen",
    "education.item2.title": "Bachelor of Arts",
    "education.item2.description":
      "Banking, Finanz- und Rechnungswesen - Fama Universität, Prishtina, Kosovo (Oktober 2006 - April 2010)",
    "education.item2.tag1": "Banking",
    "education.item2.tag2": "Finanzen",
    "education.item2.tag3": "Rechnungswesen",
    "education.item3.title": "Deutschkurs - TELC",
    "education.item3.description":
      "Zertifikate A1 bis B2. Fließend in Deutsch, mit starken Kommunikationsfähigkeiten.",
    "education.item3.tag1": "Deutsch A1-B2",
    "education.item3.tag2": "TELC-zertifiziert",
    "education.item4.title": "Englischkurs",
    "education.item4.description":
      "Pre-Intermediate Englisch - New Age School, Prishtina. Fließend in Englisch für professionelle Kommunikation.",
    "education.item4.tag1": "Englisch",
    "education.item4.tag2": "Pre-Intermediate",
    "education.item5.title": "Ausgabenbeauftragte-Schulung",
    "education.item5.description":
      "Finanzsektor-Schulung vom Finanzministerium, Prishtina. Spezialisiert auf Budgetüberwachung und Ausgabenverwaltung.",
    "education.item5.tag1": "Finanzen",
    "education.item5.tag2": "Budgetverwaltung",
    "education.item6.title": "Abitur (Matura)",
    "education.item6.description":
      "Sekundärbildung abgeschlossen an der Jeta e Re, Suhareka, Kosovo (September 2003 - August 2006)",
    ...
    "contact.description":
      "Ich bin offen für Gespräche über neue Möglichkeiten, Zusammenarbeit und wie ich meine Fähigkeiten in Ihre Organisation einbringen kann.",
...
if (hamburger && mobileMenu) {
  // Ensure mobile menu is initially closed (already has -left-full in HTML)
  hamburger.setAttribute("aria-expanded", "false");

  hamburger.addEventListener("click", (e) => {
    e.stopPropagation();
    // Toggle between -left-full (closed) and left-0 (open)
